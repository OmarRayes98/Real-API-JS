...
// 
    ...
    { 
        ...
        toggleLoader(true)
        await axios.get(`${baseUrl}/posts?limit=6&page=${page}`)
        .then((response) => {
            toggleLoader(false)
            ...
            for(let post of posts)
            {
                ...
                if(typeof author.profile_image ==="string"){
                    postAuthorImage = author.profile_image;
                }
                    ...
                    <div class="card shadow">
                        <div class="card-header">
                            ...
                            <span onclick="userClicked(${author.id})" style="cursor: pointer">
                                ...
                                <img class="rounded-circle border border-2" src="${postAuthorImage}" alt="" style="width: 40px; height: 40px">
                        ...
                        <div class="card-body" onclick="postClicked(${post.id})" style="cursor: pointer">
                            <img class="w-100 img-home" src="${post.image}" alt="">
